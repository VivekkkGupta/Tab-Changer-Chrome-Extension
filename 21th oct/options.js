...
function saveOptions() {
  const scrollPixels = parseInt(document.getElementById("scrollPixels").value); // Default value
  const intervalTime = parseInt(document.getElementById("intervalTime").value); // Default value
